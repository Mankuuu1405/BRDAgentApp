...
const SignIn = ({ navigation }) => {
  ...
  const roleOptions = [
    { label: 'Field Verification Agent', value: ROLES.FIELD_INVESTIGATION },
  ...
  const handleSignIn = () => {
    ...
    } else if (selectedRole === ROLES.CHANNEL_PARTNER) {
      navigation.navigate('ChannelPartnerMain');
    } else {
      Alert.alert('Coming Soon', 'Collection Agent interface is under development');
    }
  };
